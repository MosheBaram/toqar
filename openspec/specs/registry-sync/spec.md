...
Registry-as-code: the analytics/registry.json file format and the
toqar sync diff/apply/pull workflow keeping customer repos and the
registry backend in agreement.
