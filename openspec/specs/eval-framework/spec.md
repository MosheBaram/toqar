...
Online + offline evaluation of agent quality: trajectory-level scorers, the LLM-judge signal class (directional, versioned, excluded from the citation contract), versioned datasets, human feedback linkage, judge calibration, and the CI eval gate.
